...
Avec shutil, on peut copier des fichiers avec la fonction `copy`:
...
## Créer une archive: `shutil.make_archive()`
...
## Décompresser une archive: `shutil.unpack_archive()`
